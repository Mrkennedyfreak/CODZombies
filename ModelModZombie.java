...
public class ModelModZombie extends ModelBase
{
  ...
  private void setRotation(ModelRenderer model, float x, float y, float z)
  {
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
    {
        ...
        this.Right_Arm.rotateAngleY = -(0.1F - f6 * 0.6F);
        this.Left_Arm.rotateAngleY = 0.1F - f6 * 0.6F;
        this.Right_Arm.rotateAngleX = -((float)Math.PI / 2F);
        this.Left_Arm.rotateAngleX = -((float)Math.PI / 2F);
        this.Right_Arm.rotateAngleX -= f6 * 1.2F - f7 * 0.4F;
        this.Left_Arm.rotateAngleX -= f6 * 1.2F - f7 * 0.4F;
        this.Right_Arm.rotateAngleZ += MathHelper.cos(par3 * 0.09F) * 0.05F + 0.05F;
        this.Left_Arm.rotateAngleZ -= MathHelper.cos(par3 * 0.09F) * 0.05F + 0.05F;
        this.Right_Arm.rotateAngleX += MathHelper.sin(par3 * 0.067F) * 0.05F;
        this.Left_Arm.rotateAngleX -= MathHelper.sin(par3 * 0.067F) * 0.05F;
        //
        this.Right_Thumb.rotateAngleZ = 0.0F;
        this.Left_Thumb.rotateAngleZ = 0.0F;
        this.Right_Thumb.rotateAngleY = -(0.1F - f6 * 0.6F);
        this.Left_Thumb.rotateAngleY = 0.1F - f6 * 0.6F;
        this.Right_Thumb.rotateAngleX = -((float)Math.PI / 2F);
        this.Left_Thumb.rotateAngleX = -((float)Math.PI / 2F);
        this.Right_Thumb.rotateAngleX -= f6 * 1.2F - f7 * 0.4F;
        this.Left_Thumb.rotateAngleX -= f6 * 1.2F - f7 * 0.4F;
        this.Right_Thumb.rotateAngleZ += MathHelper.cos(par3 * 0.09F) * 0.05F + 0.05F;
        this.Left_Thumb.rotateAngleZ -= MathHelper.cos(par3 * 0.09F) * 0.05F + 0.05F;
        this.Right_Thumb.rotateAngleX += MathHelper.sin(par3 * 0.067F) * 0.05F;
        this.Left_Thumb.rotateAngleX -= MathHelper.sin(par3 * 0.067F) * 0.05F;
        //
